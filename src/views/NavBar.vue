<template>
  <nav
    ...
    class="navbar navbar-expand-lg nav-color mb-0"
  >
  ...
  <nav class="navbar nav-color2 justify-content-center">
    <router-link class="navbar-brand" :to="{ name: 'CadastroPets' }"
      >Pets</router-link
    >
    <router-link class="navbar-brand" :to="{ name: 'Agendamentos' }"
    ...
    <router-link v-if="userType !== 'Cliente'" class="navbar-brand" :to="{ name: 'AdmCadastro' }">Usuários</router-link>
